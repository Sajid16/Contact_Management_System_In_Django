...
class ContactCustomization(admin.ModelAdmin):
    ...
    # list_editable = ('name',)
    list_display_links = ('date_added',) # list_display_links item cannot be in list_editable
    list_editable = ('gender','name') # here comma has a massive role if tuple has only one item
    list_per_page = 1 # pagination process
